import { BarcodeView as BarcodeScannerBaseView, beepOnScanProperty, formatsProperty, pauseProperty, preferFrontCameraProperty, torchOnProperty, } from './barcodeview-common';
...
const getBarcodeTypes = (formatsString) => {
    const types = new java.util.ArrayList();
